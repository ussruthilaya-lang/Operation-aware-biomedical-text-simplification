# BioBERT Operation Classifier (Model 3 in progression)
#
# Third rung of three-model progression: TF-IDF -> BERT-base -> BioBERT.
# Question it answers: does biomedical-specific pretraining help predict operations
# better than general contextual pretraining (BERT-base)?
#
# Input  = SOURCE sentence only (same as TF-IDF, BERT-base).
...
if __name__ == "__main__":
    ...
    print("\n=== Saving checkpoint ===")
    os.makedirs("models/biobert_operation_classifier", exist_ok=True)
    model.save_pretrained("models/biobert_operation_classifier")
    tokenizer.save_pretrained("models/biobert_operation_classifier")
    print("✓ Checkpoint saved to models/biobert_operation_classifier/")