...
# This is why your Stage 3 routes SUBSTITUTION through CHV, not LLM.

# CHV lookup table — subset of Consumer Health Vocabulary
# Full CHV: https://www.nlm.nih.gov/research/umls/sourcereleasedocs/current/CHV/
# This is a representative sample for prelim — full integration with GCP/UMLS later
...
CHV_LOOKUP = {
    ...
    "oral": "by mouth",
    "intravenous": "into the vein",
    "intravenously": "through a vein",  # adverb form — separate entry
    "subcutaneous": "under the skin",
    "subcutaneously": "under the skin",  # same pattern
    "oral": "by mouth",
    "orally": "by mouth"
}
...
def chv_substitute(text):
    ...
    Exact matching trades recall for precision — right call for healthcare.
    """
    result = text
...
def split_long_sentence(text, max_words=35):
    ...
    Targets conjunctions and semicolons — syntactically safe split points.
