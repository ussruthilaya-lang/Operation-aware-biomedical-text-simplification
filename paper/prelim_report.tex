...
progression. The \textbf{TSAR shared task}~\cite{alvamanchego2025tsarfindings} documents the field's
...
\bibitem{alvamanchego2025tsarfindings}
Alva-Manchego, F., Stodden, R., Imperial, J. M., Barayan, A., North, K.,
\& Tayyar Madabushi, H. (2025). Findings of the TSAR 2025 Shared Task on
Readability-Controlled Text Simplification. Proceedings of the Fourth
Workshop on Text Simplification, Accessibility and Readability (TSAR 2025),
116--130.
...
neural baselines (Lay-SciFive and BART-w-CTs~\cite{li2024beemanc}) and
